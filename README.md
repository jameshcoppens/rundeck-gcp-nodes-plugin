...
Version: 0.1.6 [CHANGELOG](https://github.com/Neutrollized/rundeck-gcp-nodes-plugin/blob/master/CHANGELOG.md)
...
Put the `rundeck-gcp-nodes-plugin-0.1.6.jar` into your `$RDECK_BASE/libext` dir.
