    ...
    public GCPResourceModelSource(final Properties configuration) {
        ...
        */
        ...
        //if (null != clientId && null != clientSecret) {
            try {
                GoogleCredential credential = GoogleCredential.fromStream(new FileInputStream("/Users/jameshcoppens/Documents/YellowHammer/rundeck/etc/rundeck-gcp-nodes-plugin.json"))
